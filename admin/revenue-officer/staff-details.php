                            ...
                            <div class="tile-body">
                                <table class="table table-hover table-bordered" id="sampleTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Operation</td>
                                            <td><a href="edit-staff-details.php?staff_number=<?php echo $staff_number ?>"><i class="fa fa-pencil"></i> EDIT  DETAILS</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="tile">
                            <div class="tile-body">
                                <div class="tile-body"><?php
                                    $staff_activity = $db->prepare("SELECT * FROM activity WHERE user_details=:staff_email ORDER BY act_id DESC LIMIT 0,10");
                        ...
                        <div class="tile">
                            <div class="row">
                                <div class="col-lg-12" align="center">
                                    <a href="" class="btn btn-success">EDIT <?php echo strtoupper($staff_name) ?> BIODATA DETAILS</a>
                                </div>
                            </div>
                        </div>
                    </div>
