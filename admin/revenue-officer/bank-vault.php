...
<main class="app-content">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="bank-vault.php?bank_name=<?php echo $bank_name ?>"><i class="fa fa-cloud"></i> <?php echo $bank_name ?> IGR Vault </a></li>
            <li class="breadcrumb-item"><a href="view-all-bank-vault"><i class="fa fa-cloud"></i> View All IGR Vault </a></li>
                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="tile-body"><?php
                                $vault = $db->prepare("SELECT * FROM vault WHERE bank_name=:bank_name ORDER BY vault_id DESC ");
                                $arrAct = array(':bank_name'=>$bank_name);
                                $vault->execute($arrAct);
                                if($vault->rowCount()==0){  ?>
