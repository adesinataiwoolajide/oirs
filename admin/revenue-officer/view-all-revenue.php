        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <div class="tile-body"><?php
                    $min=$db->prepare("SELECT * FROM state_revenue WHERE staff_number=:staff_number ORDER BY reciept_number DESC");
                    $minarr = array(':staff_number'=>$staff_number);
                    $min->execute($minarr);
                    if($min->rowCount()==0){ ?>
                        <h5><p style="color: red"  align="center"><?php echo $staff_name. " You Have Not Collected Any Revenue" ?></p></h5><?php
                    }else{ ?>
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tbody><?php
                                ...
                                while($see_ministry = $min->fetch()){
                                    $revenue_id = $see_ministry['revenue_id'];
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $reciept_number= $see_ministry['reciept_number']; ?></td>
                                        <td><?php echo $see_ministry['payer_name']; ?></td>
                                        <td><?php echo $see_ministry['payer_phone']; ?></td>
                                        <td><?php echo $see_ministry['payer_address']; ?></td>
                                        
                                        <td>
                                            <a href="edit-revenue-details.php?customer_reciept_number=<?php echo $reciept_number?>" class="" onclick="return(confirmToEdit());"><i class="fa fa-pencil"></i> 
                                            </a> 
                                            <!-- <a href="delete-revenue-details.php?customer_reciept_number=<?php echo $reciept_number?>&&local_govt_name=<?php echo $local_govt_name ?> &&ministry_name=<?php echo $ministry_name ?>" class="" onclick="return(confirmToDelete());"><i class="fa fa-trash"></i> 
                                            </a> -->
                                            <a href="print-reciept.php?customer_reciept_number=<?php echo $reciept_number?>" class="" onclick="return(confirmToPrint());"><i class="fa fa-print"></i> 
                                            </a>
                                        </td>
                                    </tr><?php
                                    $y++;
...
<script>
    function confirmToPrint(){
        return confirm("Click okay to Print Revenue Receipt and Cancel to Stop");
    }
</script>    
