        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <div class="tile-body"><?php
                    $day = date("d");
                    $min = $db->prepare("SELECT * FROM state_revenue WHERE today=:day AND local_govt_id=:local_govt_id ORDER BY revenue_id DESC");
                    $arrMin = array(':day'=>$day, ':local_govt_id'=>$local_govt_id);
                    $min->execute($arrMin);
                    if($min->rowCount()==0){ ?>
                        <h5><p style="color: red"  align="center">The Revenue Report in <?php echo $local_govt_name . " For ".date("d") ?> is Empty</p></h5><?php
                    }else{ ?>
                        <div align="center">
                            <h1 style="color: green"><i class="fa fa-th-list"></i> State of Osun Revenue  Report</h1>
                            <p style="color: blue">OSUN STATE REVENUE REPORT FOR  <?php echo $local_govt_name . " For ". date("d-m-Y"); ?></p>
                        </div>
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tbody><?php
                                ...
                                while($see_report = $min->fetch()){ 
                                    ...
                                    $reciept_number = $see_report['reciept_number']; ?>
                                    <tr>
                                        <td><?php echo $y ?><a href="print-reciept.php?customer_reciept_number=<?php echo $reciept_number?>" class="" onclick="return(confirmToPrint());"><i class="fa fa-print"></i> </td>
