                        ...
                        <div class="tile">
                            <div class="tile-body">
                                <div class="tile-body"><?php
                                    $staff_activity = $db->prepare("SELECT * FROM activity WHERE user_details=:staff_email ORDER BY act_id DESC LIMIT 0,6");
                                    ...
                                    <div class="col-lg-12" align="center">
                                        <a href="my-activities-log.php" class="btn btn-success">VIEW ALL MY ACTIVITY LOG</a>
                                    </div>
                                </div>
                            </div>
                        </div>
