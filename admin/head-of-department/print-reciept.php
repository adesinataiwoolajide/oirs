...
<main class="app-content">
    <div class="app-title">
        <div>
            ...
            <p style="color: blue"><?php echo $local_govt_name ?> CUSTOMER REVENUE PAYMENT RECIEPT</p>
        </div>
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                    	...
                    	<tbody>
                    		<tr>
                    			...
                    			<td>
									<img src="../icons/iGRLogo.jpeg" align="right" style="margin-top: -5px; width: 250px; height: 150px; margin-right: -10px;">
								</td>
                    		</tr>
                    	</tbody>
                    	</strong>
