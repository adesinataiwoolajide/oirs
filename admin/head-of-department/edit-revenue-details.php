                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="tile">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"><i class="fa fa-lg fa-fw fa-id-badge"></i> Staff Local Government</label>
                                            <input class="form-control"  type="text" name="" value="<?php echo $local_govt_name ?>" placeholder="Enter The Staff Name" readonly>
                                            <span style="color: pink">** This Field is Readonly **</span>
                                        </div>
                                        <div class="form-group">
