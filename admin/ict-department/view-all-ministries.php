                                ...
                                while($see_ministry = $min->fetch()){ ?>
                                    <tr>
                                        <td><?php echo $y ?>
                                            ...
                                            <a href="delete-ministry.php?ministry_code=<?php echo $ministry_code ?>&&ministry_name=<?php echo $name; ?>" class="btn btn-danger" onclick="return(confirmToDelete());"><i class="fa fa-lg fa-fw fa-trash"></i> </a>
                                        </td>
