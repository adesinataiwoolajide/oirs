    ...
    <div class="app-title">
        <div>
	         <div>
                ...
                <p style="color: blue">All Staff Activities Log</p>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="tile">
                <div class="row">
                    <div class="col-lg-12">
                        <h3><p align="center" style="color: green"> Please Preview All The Staff Activities Log Below </p></h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="tile-body"><?php
                                $staff_activity = $db->prepare("SELECT * FROM activity ORDER BY act_id DESC ");
                                //$arrAct = array(':staff_email'=>$staff_email);
                                $staff_activity->execute();
                                if($staff_activity->rowCount()==0){  ?>
                                    <p style="color: red" align="center">The Staff Activity Log is Empty </p><?php
                                }else{?>
