        ...
        if($gettLocal->rowCount()==0){ ?>
            ...
            while($see_local = $gettLocal->fetch()){
                ...
                <div class="col-md-3" style="margin-bottom: 15px;">
                    <div class="card" onclick="location.href='view-local_govt-revenue.php?local_govt_code=<?php echo $code ?>&&local_govt_id=<?php echo $local_govt_id ?>';">
                        <div align="center">
                            <img src="../icons/localll.png" style="width: 100px; height: 100px;" align="center">
