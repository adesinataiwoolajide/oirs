        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <div class="tile-body"><?php
                    $day = date("d");
                    $min = $db->prepare("SELECT * FROM state_revenue WHERE today=:day ORDER BY revenue_id DESC");
                    $arrMin = array(':day'=>$day);
                    $min->execute($arrMin);
                    if($min->rowCount()==0){ ?>
                        <h5><p style="color: red"  align="center">The Revenue Report For <?php echo date("d") ?> is Empty</p></h5><?php
                    }else{ ?>
                        <div align="center">
                            <h1 style="color: green"><i class="fa fa-th-list"></i> State of Osun Revenue  Report</h1>
                            <p style="color: blue">OSUN STATE REVENUE REPORT FOR <?php echo date("d-m-Y"); ?></p>
                        </div>
